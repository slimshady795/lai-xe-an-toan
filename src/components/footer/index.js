...
import { getImg, INFORMATION } from '../../constants';
        ...
        <div className='container'>
          ...
          <div className='social'>
            <a href={INFORMATION.FACEBOOK} target="_blank" rel="noreferrer">
              <img src={getImg('logo/fb-logo.png')} alt='' />
            </a>
            <a href={INFORMATION.ZALO} target="_blank" rel="noreferrer">
              <img src={getImg('logo/zalo-logo.png')} alt='' />
            </a>
          </div>
        </div>
      </div>
